...
const (
	...
	// PrefixMesh defines the storage prefix for the mesh.
	PrefixMesh

	// PrefixMarkers defines the storage prefix for the markers used to optimize structural checks in the mesh.
	PrefixMarkers
