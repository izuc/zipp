...
import (
	...
	"github.com/izuc/zipp.foundation/core/generics/dataflow"
	...
	wp "github.com/izuc/zipp/packages/node/warpsync/warpsyncproto"
		...
		eg.Go(func() error {
			...
			for it := validPeers.Iterator(); it.HasNext() && !success; {
				...
				dataflow.New(
					...
					peerID:        peerID,
					meshTree:    meshTree,
					epochBlocks:   make(map[mesh_old.BlockID]*mesh_old.Block),
				})
			}
