...
export class Mana extends React.Component<Props, any> {
    render() {
        ...
        return (
            <Container>
                {
                    !nodeStore.status.meshTime.synced &&
                ...
                <Row className="mb-3">
                    <Col>
                        <ManaEventList
                            title={"Access Events"}
                            listItems={nodeStore.status.meshTime.synced?  manaStore.accessEventList: [manaStore.nodeNotSyncedListItem]}
                    ...
                    <Col>
                        <ManaEventList
                            ...
                            listItems={nodeStore.status.meshTime.synced? manaStore.consensusEventList: [manaStore.nodeNotSyncedListItem]}
