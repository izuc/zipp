...
type ParametersDefinition struct {
	...
	// MeshTimeWindow defines the time window in which the node considers itself as synced according to MeshTime.
	MeshTimeWindow time.Duration `default:"20s" usage:"the time window in which the node considers itself as synced according to MeshTime"`
